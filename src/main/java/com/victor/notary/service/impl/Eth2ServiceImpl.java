...
@Service(value = "eth2Service")
public class Eth2ServiceImpl implements Eth2Service {
    @Resource
    ...
    public void updateMoney(String money, String userAddress) {
        ethUser2Mapper.updateMoneyByUserAddr(userAddress, money);
    }
                               ...
                               BigInteger value) throws Exception
    {
        ...
        // 获取账户密码
        String password = ethUser2Mapper.selectByUserAddress(fromAddress).getPassword();
        // 通过admin进行账户解锁
        ...
        System.out.println("以太坊链--2---提交交易成功！！！");
     ...
     */
    @Override
    public List<EthUser2> selectAll() {
        return ethUser2Mapper.selectAll();
    }
}
